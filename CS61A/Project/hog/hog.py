...
def roll_dice(num_rolls, dice=six_sided):
    ...
    # BEGIN PROBLEM 1
    "*** YOUR CODE HERE ***"
    all_dice_result = [dice() for _ in range(num_rolls)]
    
    return 1 if 1 in all_dice_result else sum(all_dice_result)   
    # END PROBLEM 1
